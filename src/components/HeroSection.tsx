    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        <div className="relative w-48 sm:w-56 md:w-64 mx-auto mb-8">
          {/* Steam effect */}
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[120%] h-40 pointer-events-none z-20">
            <div className="absolute left-[12%] bottom-0 w-5 h-24 rounded-full bg-white/60 blur-xl animate-steam-rise" style={{ animationDelay: '0s' }} />
            <div className="absolute left-[22%] bottom-0 w-6 h-28 rounded-full bg-white/50 blur-2xl animate-steam-rise" style={{ animationDelay: '0.4s' }} />
            <div className="absolute left-[32%] bottom-0 w-5 h-28 rounded-full bg-white/55 blur-xl animate-steam-rise" style={{ animationDelay: '0.2s' }} />
            <div className="absolute left-[42%] bottom-0 w-7 h-32 rounded-full bg-white/60 blur-2xl animate-steam-rise" style={{ animationDelay: '0.6s' }} />
